...
run this below to open localhost://8000/docs for testing 
uvicorn python_fastapi.fetch_req_diagramType:app –reload   // here need to be careful if your python folder is python_fastapi or python_fastAPI_fetch_clean and you can get fetch_req_diagramType function run 

5.copy paste below test code for testing in the localhost://8000/docs
{
