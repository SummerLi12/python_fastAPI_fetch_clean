...
// here need to be careful if your python folder is python_fastapi or python_fastAPI_fetch_clean and you can get fetch_req_diagramType function run 

7. type this in terminal fo testing //make sure you are in python_fastapi dir run this
